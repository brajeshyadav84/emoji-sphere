...
const GroupPostsFeed = ({ className = "", useStoredProcedure = false }: GroupPostsFeedProps) => {
      ...
      {postsData && !postsData.last && (
        <div className="text-center py-4">
          <Button
            ...
            variant="outline"
            disabled={isFetching}
            className="transform transition-all duration-200 hover:scale-105 active:scale-100 focus:outline-none focus-visible:ring-0"
          >
