...
import { Beaker, Clock, CheckCircle, XCircle, Trophy, Home, BookOpen } from 'lucide-react';
import scienceQuestions from '@/data/exam/scienceQuestions.json';
...
const ScienceExam: React.FC = () => {
  ...
  const grades = scienceQuestions.grades as GradesData;
  ...
  const getScoreMessage = (percentage: number) => {
    if (percentage >= 80) return 'Outstanding! You have excellent scientific knowledge.';
    if (percentage >= 60) return 'Well done! Keep exploring the world of science.';
    return 'Keep learning! Science is all around us and very exciting.';
  };
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="bg-white shadow-xl">
                <CardHeader className="text-center">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-r from-green-400 to-green-600 flex items-center justify-center text-white mb-4 mx-auto">
                    <Beaker className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-3xl font-bold text-gray-800">Science Exam</CardTitle>
                  <p className="text-gray-600 mt-2">Explore the wonders of science and test your knowledge</p>
                </CardHeader>
                    ...
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg">
                          ...
                          <span className="font-bold text-orange-600">Science</span>
                        </div>
                      </div>
                      ...
                      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        ...
                        <ul className="space-y-1 text-sm text-yellow-700">
                          <li>• Read each question carefully and think about the science behind it</li>
                      ...
                      <div className="flex gap-4">
                        ...
                        <Button 
                          ...
                          className="flex-1 bg-gradient-to-r from-green-400 to-green-600 hover:opacity-90"
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="max-w-4xl mx-auto">
              <Card className="bg-white shadow-xl mb-6">
                <CardHeader className="text-center">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-r from-green-400 to-green-600 flex items-center justify-center text-white mb-4 mx-auto">
                    <Trophy className="h-10 w-10" />
                  </div>
                  <CardTitle className="text-3xl font-bold text-gray-800">Exam Complete!</CardTitle>
                  <p className="text-gray-600 mt-2">Here are your results for the Science exam</p>
                </CardHeader>
                <CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-800">Science Exam</span>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  {currentQuestion === questions.length - 1 ? (
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-green-400 to-green-600 hover:opacity-90"
                    >
                      Next
                    </Button>
                  )}
