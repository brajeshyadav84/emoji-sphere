...
import { Calculator, Clock, CheckCircle, XCircle, Trophy, Home, BookOpen } from 'lucide-react';
import mathQuestions from '@/data/exam/mathQuestions.json';
...
const MathExam: React.FC = () => {
  ...
  const grades = mathQuestions.grades as GradesData;
  ...
  const getScoreMessage = (percentage: number) => {
    if (percentage >= 80) return 'Excellent work! You have a strong understanding of mathematics.';
    if (percentage >= 60) return 'Good job! Keep practicing to improve your math skills.';
    return 'Keep studying! Mathematics gets easier with practice.';
  };
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="bg-white shadow-xl">
                <CardHeader className="text-center">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center text-white mb-4 mx-auto">
                    <Calculator className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-3xl font-bold text-gray-800">Mathematics Exam</CardTitle>
                  <p className="text-gray-600 mt-2">Test your mathematical knowledge and problem-solving skills</p>
                </CardHeader>
                    ...
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                          ...
                          <span className="font-bold text-green-600">20 minutes</span>
                        </div>
                        ...
                        <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg">
                          ...
                          <span className="font-bold text-orange-600">Mathematics</span>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4">
                        ...
                        <Button 
                          ...
                          className="flex-1 bg-gradient-to-r from-blue-400 to-blue-600 hover:opacity-90"
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="max-w-4xl mx-auto">
              <Card className="bg-white shadow-xl mb-6">
                <CardHeader className="text-center">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center text-white mb-4 mx-auto">
                    <Trophy className="h-10 w-10" />
                  </div>
                  <CardTitle className="text-3xl font-bold text-gray-800">Exam Complete!</CardTitle>
                  <p className="text-gray-600 mt-2">Here are your results for the Mathematics exam</p>
                </CardHeader>
                <CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-800">Mathematics Exam</span>
                  </div>
