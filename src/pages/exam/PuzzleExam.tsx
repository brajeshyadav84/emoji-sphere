...
import { PuzzleIcon, Clock, CheckCircle, XCircle, Trophy, Home, BookOpen } from 'lucide-react';
import puzzleQuestions from '@/data/exam/puzzleQuestions.json';
...
const PuzzleExam: React.FC = () => {
  ...
  const grades = puzzleQuestions.grades as GradesData;
  ...
  }, [selectedGrade, examStarted, grades]);  useEffect(() => {
  ...
  const getScoreMessage = (percentage: number) => {
    if (percentage >= 80) return 'Amazing! You have excellent problem-solving skills.';
    if (percentage >= 60) return 'Great job! Keep challenging your mind with puzzles.';
    return 'Keep practicing! Puzzles help develop logical thinking skills.';
  };
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="bg-white shadow-xl">
                <CardHeader className="text-center">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-r from-orange-400 to-orange-600 flex items-center justify-center text-white mb-4 mx-auto">
                    <PuzzleIcon className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-3xl font-bold text-gray-800">Puzzle Exam</CardTitle>
                  <p className="text-gray-600 mt-2">Challenge your mind with fun puzzles and brain teasers</p>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    ...
                    <ul className="space-y-1 text-sm text-yellow-700">
                      <li>• Think creatively and use logical reasoning</li>
                      <li>• Take your time to understand each puzzle</li>
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="bg-white shadow-xl mb-6">
                <CardHeader className="text-center">
                  ...
                  <p className="text-gray-600 mt-2">Here are your results for the Puzzle exam</p>
                </CardHeader>
                <CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-800">Puzzle Exam</span>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  {currentQuestion === questions.length - 1 ? (
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-orange-400 to-orange-600 hover:opacity-90"
                    >
                      Next
                    </Button>
                  )}
