    ...
    <div className={`min-h-screen bg-gray-100 ${isFullscreen ? 'fixed inset-0 z-50 bg-black' : ''}`}>
      ...
      <div className={`${isFullscreen ? 'h-full' : 'container mx-auto py-4 md:py-6 px-4'}`}>
        <div className={`${isFullscreen ? 'h-full' : 'max-w-6xl mx-auto'}`}>
          ...
          {!isFullscreen && (
            <div className="mb-4 md:mb-6">
              <Button 
                ...
                variant="outline" 
                className="flex items-center gap-2 mb-3 md:mb-4 text-sm md:text-base"
                size="sm"
              >
                <ArrowLeft className="h-3 w-3 md:h-4 md:w-4" />
                Back to Classe Rooms
              </Button>
              ...
              <div style={{display: 'none'}} className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">Class ID: {meetingId}</p>
                </div>
          ...
          {/* Meeting Interface */}
          {meetingStarted ? (
            <div className={`${isFullscreen ? 'h-full' : 'min-h-[500px] md:min-h-[600px]'} bg-gradient-to-br rounded-lg overflow-hidden relative flex items-center justify-center px-4`}>
              <div className="text-center max-w-2xl w-full">
                <div className="bg-white rounded-xl shadow-lg p-4 md:p-8">
                  <Video className="h-12 w-12 md:h-16 md:w-16 mx-auto mb-4 md:mb-6 text-blue-600" />
                  <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-gray-800">Ready to Join Meeting</h2>
                  <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6">Choose how you'd like to join the meeting:</p>
                  ...
                  <div className="space-y-3 md:space-y-4">
                    ...
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-3 md:p-4">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div className="text-left">
                          <h3 className="font-semibold text-blue-900 text-sm md:text-base">Zoom Desktop App</h3>
                          <p className="text-xs md:text-sm text-blue-700">Best experience with full features</p>
                        </div>
                        <Button 
                    ...
                    <div className="bg-green-50 border-2 border-green-200 rounded-lg p-3 md:p-4">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div className="text-left">
                          <h3 className="font-semibold text-green-900 text-sm md:text-base">Web Browser</h3>
                          <p className="text-xs md:text-sm text-green-700">Join directly in your browser</p>
                        </div>
                        <Button 
                          onClick={handleJoinWebBrowser}
                          variant="outline"
                          className="border-green-600 text-green-600 hover:bg-green-50 w-full sm:w-auto text-sm md:text-base"
                          size="sm"
                        >
                    ...
                    {/* Direct URL Option */}
                    <div style={{display: 'none'}} className="bg-gray-50 border-2 border-gray-200 rounded-lg p-4">
                      <div className="text-left">
                  ...
                  <div className="mt-4 md:mt-6 p-3 md:p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-left">
                        <h4 className="font-medium text-yellow-800 mb-1 text-sm md:text-base">Having trouble joining?</h4>
            ...
            <div className="grid gap-4 md:gap-6 grid-cols-1 lg:grid-cols-2">
              ...
              <Card className="border-blue-500 bg-blue-50">
                <CardHeader className="pb-3 md:pb-4">
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center gap-2 text-base md:text-lg">
                    ...
                    <Badge className="bg-green-500 w-fit text-xs">Ready to Join</Badge>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3 md:space-y-4 pt-0">
                  <div className="space-y-2 md:space-y-3">
                    <div className="flex flex-col xs:flex-row xs:items-center gap-1 xs:gap-2 text-xs md:text-sm">
                      ...
                      <span className="font-mono bg-gray-200 px-2 py-1 rounded text-xs md:text-sm break-all">{meetingId}</span>
                    </div>
                    ...
                    {password && (
                      <div className="flex flex-col xs:flex-row xs:items-center gap-1 xs:gap-2 text-xs md:text-sm">
                        ...
                        <span className="font-mono bg-gray-200 px-2 py-1 rounded text-xs md:text-sm break-all">{password}</span>
                      </div>
                    )}
                    ...
                    <div className="flex flex-col xs:flex-row xs:items-center gap-1 xs:gap-2 text-xs md:text-sm">
                      ...
                      <Badge variant="outline" className="text-green-600 border-green-600 w-fit text-xs">
                        Ready to join
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="pt-3 md:pt-4 border-t space-y-2 md:space-y-3">
                    <Button 
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-sm md:text-base"
                      size="default"
                    >
              ...
              <Card>
                <CardHeader className="pb-3 md:pb-4">
                  <CardTitle className="text-base md:text-lg">Before You Join</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3 md:space-y-4 pt-0">
                  <div className="bg-blue-50 p-3 md:p-4 rounded-lg">
                    <h4 className="font-semibold text-blue-900 mb-2 text-sm md:text-base">Technical Setup:</h4>
                    <ul className="list-disc list-inside space-y-1 text-blue-800 text-xs md:text-sm">
                  ...
                  <div className="bg-green-50 p-3 md:p-4 rounded-lg">
                    <h4 className="font-semibold text-green-900 mb-2 text-sm md:text-base">Meeting Etiquette:</h4>
